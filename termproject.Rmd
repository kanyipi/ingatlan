...
p6 <- chck_sp_log(df,"logarea", "Log S
                  ize")
...
- $`r alpha`$ is hard to interpret as both sides are in log, so we are more interested in the differences
