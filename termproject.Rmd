...
The filtering is selecting these variables, removing the ones with NA values, and filtering on size and price, so that remaining ones are liveable houses.
